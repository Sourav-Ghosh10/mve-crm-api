...
const attendanceController = {
    ...
    getEarlyLeaves: async (req, res, next) => {
        try {
            // TODO: Implement get early leaves logic
            res.status(501).json({
                success: false,
    ...
    approveEarlyLeave: async (req, res, next) => {
        try {
            // TODO: Implement approve early leave logic
            res.status(501).json({
                success: false,
                message: 'Not implemented yet',
            });
    ...
    rejectEarlyLeave: async (req, res, next) => {
        try {
            // TODO: Implement reject early leave logic
            res.status(501).json({
                success: false,
                message: 'Not implemented yet',
            });
