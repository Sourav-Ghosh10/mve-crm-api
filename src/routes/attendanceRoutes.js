...
/**
 * @swagger
 * /api/attendance/early-leaving:
 *   get:
 *     summary: Get early leaving requests
 *     tags: [Attendance]
 */
router.get('/early-leaving', attendanceController.getEarlyLeaves);

/**
 * @swagger
 * /api/attendance/{id}/early-leave/approve:
 *   patch:
 *     summary: Approve early leave
 *     tags: [Attendance]
 */
router.patch('/:id/early-leave/approve', attendanceController.approveEarlyLeave);

/**
 * @swagger
 * /api/attendance/{id}/early-leave/reject:
 *   patch:
 *     summary: Reject early leave
 *     tags: [Attendance]
 */
router.patch('/:id/early-leave/reject', attendanceController.rejectEarlyLeave);
